...
#おみくじとTips
execute if score $tick time matches 0 positioned 0 0 0 run function onimeda:omikuji/summon
...
#Debug
execute as @a[team=!oni,team=!Ningen,team=!Taiki,team=!Spectator] at @s run title @s actionbar ["",{"text":"あなたは:","color":"white"},{"text":"ERROR","color":"RED"},{"text":"|||"},{"text":"鬼:","color":"red"},{"score":{"name":"$test","objective":"OniCount"},"color":"red"},{"text":"生存:","color":"gold"},{"score":{"name":"$test","objective":"NingenCount"},"color":"gold"},{"text":"待機:","color":"blue"},{"score":{"name":"$test","objective":"TaikiCount"},"color":"blue"},{"text":"観戦者:","color":"yellow"},{"score":{"name":"$test","objective":"SpectatorCount"},"color":"yellow"},{"text":"|"},{"text":"キル数:","color":"green"},{"score":{"name":"@s","objective":"kill"},"color":"green"},{"text":"|"},{"text":"連続勝利数:","color":"green"},{"score":{"name":"@s","objective":"win"},"color":"green"}]
