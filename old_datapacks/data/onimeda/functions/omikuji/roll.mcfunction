...
execute if score $countroll system matches 200 if score $omikujiroll system matches 0 run function onimeda:omikuji/rollselect/daikiti

#中吉
execute if score $countroll system matches 200 if score $omikujiroll system matches 1 run title @a title ["",{"text":"[中吉]を引いた!"}]
execute if score $countroll system matches 200 if score $omikujiroll system matches 1 run function onimeda:omikuji/rollselect/tyuukiti

#小吉
execute if score $countroll system matches 200 if score $omikujiroll system matches 2 run title @a title ["",{"text":"[小吉]を引いた!"}]
execute if score $countroll system matches 200 if score $omikujiroll system matches 2 run function onimeda:omikuji/rollselect/syoukiti

#吉
execute if score $countroll system matches 200 if score $omikujiroll system matches 3 run title @a title ["",{"text":"[吉]を引いた!"}]
execute if score $countroll system matches 200 if score $omikujiroll system matches 3 run function onimeda:omikuji/rollselect/kiti

#凶
execute if score $countroll system matches 200 if score $omikujiroll system matches 4 run title @a title ["",{"text":"[凶]を引いた!"}]
execute if score $countroll system matches 200 if score $omikujiroll system matches 4 run function onimeda:omikuji/rollselect/kyou

#大凶
execute if score $countroll system matches 200 if score $omikujiroll system matches 5 run title @a title ["",{"text":"[大凶]を引いた!"}]
execute if score $countroll system matches 200 if score $omikujiroll system matches 5 run function onimeda:omikuji/rollselect/daikyou
